...
struct linked_list *init_list(void); // Return malloced struct

int check_type(const char* input_type); // Check given input type (int / char / else)

struct linked_list *ret_int_node(struct linked_list *const head_node, const int input_value); // Return int node

struct linked_list *ret_char_node(struct linked_list *const head_node, char *const input_value); // Return char node

struct linked_list *ret_void_node(struct linked_list *const head_node, void *const input_value);

int add_node(struct linked_list *const head_node, struct linked_list *temp_node); // Add nodes to linked list

void push(struct linked_list *const head_node, const char *input_type, ...); // Interface function

int pop(struct linked_list *const head_node); // Remove last node of linked list

void display(struct linked_list *const head_node); // Display values of linked list
